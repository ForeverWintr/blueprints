...
setup(
    name=frame_factory.__name__,
    version=frame_factory.__version__,
    description='frame_factory is a function composition and data pipelining library',
    long_description=__doc__,
    url='https://github.com/ForeverWintr/metafunctions',
    author=frame_factory.__author__,
    author_email=frame_factory.__email__,
    license='MIT',
    ...
    test_suite='frame_factory.tests',
    #install_requires='',
